...
export const BLOCK_LIBRARY: Block[] = [
  ...
  { code: 'NO1', cat: 'NO', name: 'Nagłówek — standard', desc: 'Zdjęcie w tle + logo + dane', size: 'L' },
  { code: 'NO2', cat: 'NO', name: 'Nagłówek — pełnoekranowy', desc: 'Wielkie zdjęcie + tekst na dole', size: 'L' },
  { code: 'DW1', cat: 'DW', name: 'Obraz lewo + Tekst prawo', desc: 'Split 50/50', size: 'L' },
  { code: 'DW2', cat: 'DW', name: 'Tekst lewo + Obraz prawo', desc: 'Split 50/50', size: 'L' },
  { code: 'DW3', cat: 'DW', name: 'Obraz góra + Tekst dół', desc: 'Stacked', size: 'L' },
  { code: 'DW4', cat: 'DW', name: '2 kolumny', desc: '2 obrazy + 2 teksty', size: 'L' },
  { code: 'DW5', cat: 'DW', name: '3 kolumny', desc: '3 obrazy + 3 teksty', size: 'L' },
  { code: 'DW6', cat: 'DW', name: '4 kolumny', desc: '4 obrazy + 4 teksty', size: 'L' },
  { code: 'DW7', cat: 'DW', name: 'Obrazy lewo + Teksty prawo', desc: '3+3 kolumny', size: 'L' },
  { code: 'DW8', cat: 'DW', name: 'Cytat z obrazem', desc: 'Zdjęcie w tle + cytat', size: 'L' },
  { code: 'CTA1', cat: 'CTA', name: 'Zaproszenie do kontaktu', desc: 'Ciemne tło + przycisk', size: 'L' },
];
